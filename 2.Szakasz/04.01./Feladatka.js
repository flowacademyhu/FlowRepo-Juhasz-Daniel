...
d, Minden objektumban helyet kap az a változó, aminek nincs static módosítója.
...
c, Az osztálymetódus elérheti a példányváltozót.
d, A példánymetódus elérheti az osztályváltozót.

9. Melyik állítás igaz az alábbiak közül?
a, A nyilvános (public) deklarációt mindenki látja, tehát az osztály egy példányának használója, és az osztály leszármazottai is.
...
b, Az általánosítás az a folyamat, mely során több dolog leírásából kiemeljük a közös jellemzőket.
...
d, Ha ősadatra hivatkozunk, használnunk kell a this minősítést.
...
d, Fordítási hiba keletkezik az "out.close()" sorban.
...
c, Ha az interfész deklarációjában egy metódusfej előtt nem adunk meg módosítót, az alapértelmezetten public és abstract lesz.
